...
namespace WindowsFormsApplication1
{
    public partial class PRESCRIBE_MEDICINE : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                if(dbobj.insertVisitMedicine(Convert.ToInt32(txtid.Text) ,Convert.ToInt32(cbvisitid.Text), Convert.ToInt32(cbmedid.Text)))
                {
        ...
        private void btnupdate_Click(object sender, EventArgs e)
        {
            try
            {
                if(dbobj.UpdateVisitMed(Convert.ToInt32(txtid.Text) ,Convert.ToInt32(cbvisitid.Text), Convert.ToInt32(cbmedid.Text)))
                {
